			...
			<div className='w-full px-[50px] flex flex-row justify-between items-start'>
				...
				<div className='ml-64 w-[80%] rounded-xl'>
					<Routes>
						...
						<Route
							path='/QuanLyHangSX'
							element={<QuanLyLoaiSP />}></Route>
						<Route
							path='/QuanLyHangSX/AddNewLoaiSP'
							element={<AddNewLoaiSP />}></Route>
						<Route
							path='/QuanLyHangSX/Update/:idCate'
							element={<UpdateLoaiSP />}></Route>
						<Route
							path='/QuanLyHangSX/Delete/:idCate'
							element={<DeleteLoaiSP />}></Route>
						{/* List sản phẩm */}
						<Route
							path='/QuanLySanPham'
							element={<ListSanPham />}></Route>
						<Route
							path='/QuanLySanPham/AddProd'
							element={<AddProd />}></Route>
						<Route
							path='/QuanLySanPham/Delete/:idSanPham'
							element={<DeleteProd />}></Route>
						<Route
							path='/QuanLySanPham/Detail/:idSanPham'
							element={<ChiTietSanPham />}></Route>
						{/* Promotion Product */}
						<Route
							path='/QuanLySanPham/Detail/Promotion/:idPromotion/:idSanPham'
							element={<PromotionDetail />}></Route>
						{/* Specification Product */}
						<Route
							path='/QuanLySanPham/Detail/Spacification/:idThongSo/:idSanPham'
							element={<ThongSoDetail />}></Route>
						<Route
							path='/QuanLySanPham/Detail/CreateSpect/:idSanPham'
							element={<CreateThongSo />}></Route>
						{/* Promotion */}

						{/* Hoa Don */}
						<Route
							path='/QuanLyHoaDon'
							element={<QuanLyHoaDon />}></Route>
						<Route
							path='/ChiTietHoaDon/:idhoadon'
							element={<ChiTietHoaDon />}></Route>
						<Route
							path='/DeleteHoaDon/:idhoaDon'
							element={<DeleteHoaDon />}></Route>
