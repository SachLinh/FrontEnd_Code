  ...
  const getData = async () => {
    try {
      const res = await axios.get(
        `http://192.168.108.107:5000/products/${params.idSanPham}`
      );
      const initState = {
            ...
            <tr>
              ...
              <td className="w-5/6 h-[50px] pl-[10px] border border-slate-300">
                <select
                  ...
                  onChange={onChangeText}
                >
                  {listhangsX.listCata.catas ? listhangsX.listCata.catas.map((item, index) => {
                    return (
            ...
            <tr>
              ...
              <td className="w-5/6 h-[50px] pl-[10px] border border-slate-300">
                {sanPham?.ID_Spec ? (
                  ...
                  >
                    Bạn chưa cập nhật thông số   <button type="button" className="btn btn-warning">
                      Cập nhật thông số
                    </button>
                  </Link>
                )}
