	...
	return (
						...
						<div className='boss m-[5px]'>
							...
							<div className='flex flex-row font-[13px] mt-[10px] text-[13px]'>
								<div className='left w-1/2 mr-[12px]'>
									<p>
										<strong>
											CellphoneS là hệ thống bán lẻ uỷ quyền chính
											hãng của Apple Việt Nam (AAR - Apple Authorized
											Reseller).
										</strong>
									</p>
									<strong>
										Điện Thoại Vui ASP là hệ thống bảo hành chính hãng
										uỷ quyền của Apple tại Việt Nam
									</strong>
									<ul className='list-disc ml-[50px]'>
										<li>
											Nhân viên nhiệt tình, thân thiện, gửi xe & Wifi
											miễn phí
										</li>
										<li>
											Trải nghiệm trực tiếp, và dùng thử sản phẩm
											miễn phí
										</li>
										<li>
										...
										<li>
											Dịch vụ bán hàng doanh nghiệp : giá tốt nhất -
											có hoa hồng
										</li>
										<li>
											Bảo hành chính hãng, đổi mới miễn phí 1 tháng
										</li>
								...
								<div className='right w-1/2'>
									<p>
										CellphoneS là hệ thống bán lẻ uỷ quyền chính hãng
										của Apple Việt Nam (AAR - Apple Authorized
										Reseller).
									</p>
									<strong>
										Điện Thoại Vui ASP là hệ thống bảo hành chính hãng
            ...
            border-2 rounded-[5px] bg-white
             '>
						<div className='h-auto'>
							...
							<br />
							<p>
								<strong className='text-[13px]'>Khiếu nại: </strong>
								0848785548
							</p>
							<p>
								<strong className='text-[13px]'>Góp ý: </strong>
								145786645
							</p>
						</div>
						<div className='h-auto'>
							...
							<Link
								to={''}
								className='text-blue-500 italic lg:text-[15px] md:text-[13px] text-[15px]'>
								sachlinh12345@gmail.com
							</Link>
							<p>
								<strong className='text-[13px]'>
									Bán hàng daonh nghiệp{' '}
								</strong>
							</p>
							<p className='text-[13px]'>
								Gọi : 1800.2097 (Miền Nam) hoặc 1800.2044 (Miền Bắc)
								Email : cskh@cellphones.com.vn
							</p>
						</div>
					</div>
				</div>
        ...
        sm:w-[600px] '>
					<div className='box_diaChi w-full border-2 rounded-lg p-[10px]'>
						<h2 className='font-bold lg:text-[25px] md:text-[20px] sm:text-[15px]'>
							Cửa hàng bán lẻ SALI Store
						</h2>
						...
						<div className='flex flex-col lg:flex-row lg:mt-[10px] lg:justify-around'>
							<div className='lg:w-[500px] w-full '>
								<p className='text-red-600'>
									Địa chỉ:{' '}
									<strong>
										322 Mỹ Đình, Mỹ Đình 1, Nam Từ Liêm, Hà Nội
									</strong>
								</p>
								<img
									src='https://cdn.sforum.vn/sforum/wp-content/uploads/2019/04/khai-truong-cellphones-quang-trung-hoc-mon-4.jpeg'
									className=''
									alt=''
								/>
							</div>
